...
app.command(
    name="sound",
    help="Adjust the system volume.",
)(change_sound)
app.command(
    name="mute",
    help="Mute system audio.",
)(mute_sound)
app.command(
    name="unmute",
    help="Unmute system audio.",
)(unmute_sound)
app.command(
    name="clear",
    help="Clear the current menu or terminal state.",
)(clear_menu)
app.command(
    name="sleep",
...
app.command(
    name="lock",
    help="Lock the computer screen.",
)(lock_mode)

# browser commands
app.command(
    name="search",
    help="Search a query in the browser.",
)(search_command)
app.command(
    name="play",
    help="Play a song in browser-based music.",
)(play_song)
